 ...
 * @author wil
 */
public class EditarProfe extends javax.swing.JFrame {
     private EditarService<Profesor> editarService;
    int xMouse, yMouse;


    public EditarProfe() {
        initComponents();
        editarService = new ProfesorImpl();
 ...
 int filaSeleccionada = jTable1.getSelectedRow();
    if (filaSeleccionada != -1) {
        String usuarioProf = jTable1.getValueAt(0, 0).toString();
        ...
        editarService.editarElemento(usuarioProf, nombreNuevo, apellidoNuevo);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        String selectedProf = jComboBox1.getSelectedItem().toString();
        Profesor profesorSeleccionado = editarService.buscarElemento(selectedProf);

        if (profesorSeleccionado != null) {
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            Object[] rowData = {profesorSeleccionado.usuario, profesorSeleccionado.nombre, profesorSeleccionado.apellido};
            model.addRow(rowData);
        } else {
            JOptionPane.showMessageDialog(this, "Profesor no encontrado en la lista.");
        }
